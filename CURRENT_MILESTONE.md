...
>
> Project Lead Authorization: `ACS-CCV-R2-G3-G2-GPU-EXECUTION AUTHORIZED ON 2026-08-15 / BOUND TO READINESS e39ac4a8c3ddbf1f26571b295bcb00da7ff6b499acd49e8ad47291726bbbc5e4`
>
> Authorized Wave: `G3-G2 AUTHORIZATION CHECKPOINT → 51 OPAQUE REQUESTS / ONE IN FLIGHT / NO RETRY → TECHNICAL VALIDATION → STOP FOR BLIND REVIEW`
>
> Current Task: `ACS-CCV-R2-G3-G2-GPU-EXECUTION / AUTHORIZED / READY TO START`
>
> Current Work Package: `G3-G2 FAIL-CLOSED GPU EXECUTION / 51 REQUESTS MAX`
>
...
> Next Checkpoint: `G3-G2 TECHNICAL RESULT VALIDATION AND INDEPENDENT BLIND VISUAL REVIEW`
>
...
- EXECUTION MODE: `AUTO-SEQUENTIAL / BOUNDED G3 PRE-GPU / NO GPU / FAIL-CLOSED`
- AUTHORIZED WAVE: `G3-G2 AUTHORIZATION CHECKPOINT → 51 REQUEST GPU EXECUTION → TECHNICAL VALIDATION → STOP FOR BLIND REVIEW`
- CURRENT TASK: `G3-G2 GPU EXECUTION AUTHORIZED / READY TO START`
...
- CCV-R2-G3-G2: `PROJECT LEAD AUTHORIZED / READINESS-BOUND / 51 MAX / ONE IN FLIGHT / NO AUTOMATIC RETRY / READY TO START`;
...
G3-G2 GPU EXECUTION PROJECT LEAD AUTHORIZED / NOT STARTED AT THIS CHECKPOINT
...
Execute only the exact readiness-bound 51-request matrix. Stop on the first terminal
failure or after technical result validation; do not retry automatically and do not
enter acceptance or production work.

---

# 10. Current Authorized Task

`ACS-CCV-R2-G3-G2-GPU-EXECUTION / PROJECT LEAD AUTHORIZED`
...
G3-G1 is technically closed. The Project Lead has separately authorized G3-G2 against
the exact readiness SHA-256. Execution is limited to 51 queued requests, one in flight,
with no automatic retry. Technical completion does not grant validation acceptance or
