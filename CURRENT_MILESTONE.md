...
This is a preflight boundary only. It does not authorize host startup, dependency or
model installation, GPU use, Provider calls, ComfyUI, M12-C3/C4 execution, admission
or publication.
