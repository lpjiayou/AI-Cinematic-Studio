...
## 6. Core Series Planning scope and provenance closure
...
The [bounded checkpoint receipt](docs/status/CORE_SERIES_PLANNING_SCOPE_AND_CANDIDATE_BINDING_HARDENING_2026-09-05.md)
records the exact B2/F4 evidence and non-authority boundary.
...
That task requires separate authorization. M12-C3/C4, A100,
