...
That task may select and preflight a non-A100 Linux x86_64 CPU Build Host only after
separate authorization. It does not authorize M12-C3/C4, an A100 start, downloads,
runtime installation, GPU/Provider calls, admission or publication.
