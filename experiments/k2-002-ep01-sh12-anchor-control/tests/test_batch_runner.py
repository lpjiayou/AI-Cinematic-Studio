...
class T(unittest.TestCase):
 def m(self): return {'exactShotIds':list(ALLOW),'maxTotalPromptPosts':14,'maxPromptPostsPerShot':1,'automaticRetryAllowed':False,'sequentialOnly':True,'authorityState':'TECHNICAL_EVIDENCE_ONLY','publicationAllowed':False,'canonicalMutations':0,'sourceShotsJsonSha256':'52e24c8c781f2c729239d6152246677c8eb633d43d17463550c22bb91c8fd9c9','perShotSemanticDigests':{x:'0'*64 for x in ALLOW}}
 ...
 def test_05_post_total(self): self.assertEqual(self.m()['maxTotalPromptPosts'],14)
 ...
 def test_08_count(self): self.assertEqual(len(ALLOW),14)
 def test_09_order(self): self.assertEqual(ALLOW[0],'EP01_SH04')
 ...
 def test_14_bad_budget(self):
  m=self.m();m['maxTotalPromptPosts']=15;self.assertRaises(BatchError,validate_manifest,m)
