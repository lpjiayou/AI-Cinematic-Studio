# AGENTS Historical Execution Records Through 2026-09-03

Status: `HISTORICAL_EVIDENCE / IMMUTABLE PAYLOAD`

The fenced payload below is the byte-exact predecessor of the compressed root
`AGENTS.md`. It preserves its original headings, wording and links as historical
data. The payload grants no current execution authority.
