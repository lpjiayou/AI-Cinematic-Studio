...
| M12 | `ADR_0015_0020_ACCEPTED_CPU_BUILD_HOST_SELECTION_HOLD` | `EXPLICIT_M9_REQUIREMENT_BRIDGE_IMPLEMENTED` | `A100_BUILD_HOST_REFLIGHT_FAILED_CPU_HOST_UNSELECTED` | `V1_ADAPTER_COMPATIBLE_BEHAVIOR_PINNED` | `NOT_COMPLETE` | `NOT_AUTHORIZED` |
...
| M12 | ADR-0015, ADR-0019, ADR-0020 | #20/#21, #58/#63/#64; A100 reflight evidence `93c1c96d…a1ce`; accepted Option A host boundary | non-A100 CPU Build Host unselected; A100 C4 hard-offline isolation unproven; Runtime G0 incomplete | `ACS-M12-C3-CPU-BUILD-HOST-SELECTION-AND-PREFLIGHT` |
...
M12_C3_PREIMPLEMENTATION_BLOCKER=CPU_BUILD_HOST_SELECTION_AND_PREFLIGHT_PENDING
