...
| M12 | `ACCEPTED_ADR_BUILD_HOST_CONFLICT_HOLD` | `EXPLICIT_M9_REQUIREMENT_BRIDGE_IMPLEMENTED` | `BUILD_HOST_REFLIGHT_FAILED` | `V1_ADAPTER_COMPATIBLE_BEHAVIOR_PINNED` | `NOT_COMPLETE` | `NOT_AUTHORIZED` |
...
| M12 | ADR-0015, ADR-0019 | #20/#21, #58/#63/#64; A100 reflight evidence `93c1c96d…a1ce` | accepted build-host conflict, offline isolation and approved-origin blockers; Runtime G0 incomplete | `ACS-M12-BUILD-HOST-ARCHITECTURE-CORRECTION` |
...
M12_C3_PREIMPLEMENTATION_BLOCKER=BUILD_HOST_ARCHITECTURE_AND_INFRASTRUCTURE_HOLD
