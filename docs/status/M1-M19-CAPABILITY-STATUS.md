...
| M8 | `ADR_0019_ACCEPTED` | `IMPLEMENTED_ACTION_EXECUTION_BEATS_V2_PUBLIC_CUTOVER` | `SQLITE_RESTART_VERIFIED` | `BEHAVIOR_PIN_PENDING` | `IMPLEMENTED_BOUNDED` | `NOT_AUTHORIZED` |
| M9 | `ADR_0019_ACCEPTED` | `IMPLEMENTED_THREE_AXIS_REQUIREMENTS_LEGACY_G4_WRITE_FROZEN` | `SQLITE_RESTART_VERIFIED` | `BEHAVIOR_PIN_PENDING` | `IMPLEMENTED_BOUNDED` | `NOT_AUTHORIZED` |
| M10 | `ADR_0019_ACCEPTED` | `IMPLEMENTED_METHOD_AWARE_INPUT_PLANNING_PUBLIC_ROUTE` | `SQLITE_RESTART_VERIFIED_NO_MODEL_CALL` | `MAPPING_ONLY` | `IMPLEMENTED_BOUNDED` | `NOT_AUTHORIZED` |
| M11 | `ADR_0019_ACCEPTED_FAIL_CLOSED_METHOD_BOUNDARY` | `IMPLEMENTED_CLOSED_METHOD_ROUTING_LEGACY_G5_WRITE_FROZEN` | `WAN_MICRO_QUEUE_ONLY_CONTACT_GAIT_UNAVAILABLE` | `MAPPING_ONLY` | `IMPLEMENTED_BOUNDED_HISTORICAL_QC_FAILURE_PRESERVED` | `NOT_AUTHORIZED` |
...
| M12 | ADR-0015, ADR-0019 | #20/#21 and #58/#59; method-aware public cutover; A100 preflight evidence `b9945e6a…fb00` | build-host disk/origin/checkout remediation pending; Runtime G0 incomplete | `ACS-M12-A100-BUILD-HOST-INFRASTRUCTURE-REMEDIATION-AND-REFLIGHT` |
