...
| M7 | [`ADR-0019`](../../governance/ADR-0019-upstream-execution-method-and-requirement-routing.md); [`ADR-0008`](../../governance/ADR-0008-k2-single-episode-production-closure.md) remains exact K2 history | `#55` | generic M7 implementation tree tested by `#55`; historical K2 root remains unchanged | none dedicated | all Finding categories, PASS/WARN/BLOCK, staleness, replay, cross-scope and SQLite restart tests | M8 ActionExecutionBeat v2 is not implemented | PR-C after `#55` required checks and merge |
