...
| M3 | [`ADR-0002`](../../governance/ADR-0002-v5-lifecycle-integrity-boundary.md); [`ADR-0019`](../../governance/ADR-0019-upstream-execution-method-and-requirement-routing.md) | `PR-B_CURRENT_TREE` | existing v1 history plus the current M6-bound v2 implementation tree | none dedicated | `test_narrative_currentness_m7.py`; `test_creator_narrative_currentness_m7.py` SQLite restart | Frontend behavior pin remains later in this wave | PR-C only after PR-B required checks and merge |
...
| M6 | [`ADR-0003`](../../governance/ADR-0003-m6-series-intelligence-baseline.md), [`ADR-0004`](../../governance/ADR-0004-m6-series-intelligence-durable-sqlite-boundary.md), [`ADR-0005`](../../governance/ADR-0005-m6-series-intelligence-consumer-boundary.md), [`ADR-0019`](../../governance/ADR-0019-upstream-execution-method-and-requirement-routing.md) | early history `PR=UNVERIFIED`; `PR-B_CURRENT_TREE` for M3/M7 consumer closure | `5976263f92f7f9cbe9c091719eccb036ee8c0c2d` plus current consumer-binding tree | none dedicated | exact server-resolved binding and stale-baseline tests | external production authority remains unavailable by default | PR-C only after PR-B required checks and merge |
| M7 | [`ADR-0019`](../../governance/ADR-0019-upstream-execution-method-and-requirement-routing.md); [`ADR-0008`](../../governance/ADR-0008-k2-single-episode-production-closure.md) remains exact K2 history | `PR-B_CURRENT_TREE` | current generic M7 implementation tree; historical K2 root remains unchanged | none dedicated | all Finding categories, PASS/WARN/BLOCK, staleness, replay, cross-scope and SQLite restart tests | M8 ActionExecutionBeat v2 is not implemented | PR-C after PR-B required checks and merge |
