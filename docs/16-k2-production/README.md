...
ADR-0011、ADR-0012 与现有
Creator Public API → Application → V5 → V4 → V3 → Compute 主链。

当前所有文件均为：

`DRAFT / CANDIDATE / NOT DOMAIN FACT / P1 HOST-PASSED / M10 COMPLETE / M11 VIDEO PLAN COMPLETE / REAL_VIDEO_PLAN_READY / START-IMAGE EXECUTION HOST-PASSED / FOUR GPU CANDIDATES NEXT / publicationAllowed=false`
...
- [K2 内部图像优先真实媒体修订合同](../../architecture/K2_INTERNAL_IMAGE_FIRST_REAL_MEDIA_REVISION_CONTRACT.md)
