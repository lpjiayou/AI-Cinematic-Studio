...
The current phase is `ACS-CCV-R2-G3-G1-NO-GPU-PREPARATION / TOOLING IMPLEMENTATION CANDIDATE / HOST READINESS PENDING / NO GPU`.
...
- current task: `PUBLISH AND REMOTE-VERIFY G3-G1 NO-GPU PREPARATION TOOLING / HOST CROP BINDING AND READINESS RECEIPT PENDING / NO GPU`;
...
- CCV-R2-G3-G1: `NO-GPU TOOLING CANDIDATE IN THIS COMMIT / STATIC AND SYNTHETIC END-TO-END TESTS PASS / HOST CROP BINDING AND READINESS RECEIPT PENDING / NO GPU`;
