...
The current phase is `ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G2`.
...
- ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G1: `REMOTE-VERIFIED CHECKPOINT AT
  ...
  464/464`;
- ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G2: `AUTHORIZED / ONE-WINDOW READ-ONLY
  EXTERNAL HISTORICAL EVIDENCE COLLECTION / NO RERUN / CCV-R2 NOT AUTHORIZED`;
