...
The current phase is `CCV-R2-G1 CLOSED / AWAIT ACS-CCV-R2-G2-GPU-EXECUTION AUTHORIZATION`.
...
- current task: `STOP / AWAIT PROJECT LEAD AUTHORIZATION FOR ACS-CCV-R2-G2-GPU-EXECUTION`;
