...
The current phase is `ACS-CCV-R2-G2-GPU-EXECUTION / OWNER AUTHORIZED / ACTIVE`.
...
- current task: `EXECUTE THE RECEIPT-BOUND 45-RUN CCV-R2 MATRIX / MAXIMUM ONE IN FLIGHT / FAIL CLOSED`;
...
- CCV-R2-G2: `OWNER AUTHORIZED ON 2026-08-15 / ACTIVE / RECEIPT-BOUND 45-RUN GPU EXECUTION ONLY`;
