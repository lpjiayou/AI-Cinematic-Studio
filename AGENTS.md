...
The current phase is `ACS-CCV-R2-G3-REFERENCE-CONTAMINATION-REMEDIATION-G0 / OWNER AUTHORIZED / NO GPU`.
...
- current task: `FREEZE THE G3 REFERENCE-CONTAMINATION PROTOCOL / 51 UNIQUE REQUESTS / NO GPU`;
...
- CCV-R2-G3-G0: `OWNER AUTHORIZED ON 2026-08-15 / GOVERNANCE FREEZE ACTIVE / NO GPU`;
