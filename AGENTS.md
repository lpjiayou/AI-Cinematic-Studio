...
The current phase is `ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G1`.
...
- ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G1: `AUTHORIZED / EXPERIMENT-EVIDENCE
  TOOLING CLOSURE ONLY / EXTERNAL GPU ACCESS NOT STARTED / CCV-R2 NOT AUTHORIZED`;
