...
The current phase is `ACS-CCV-R2-G3-G2-GPU-EXECUTION / PROJECT LEAD AUTHORIZED / READINESS-BOUND / FAIL-CLOSED`.
...
- current task: `G3-G2 GPU EXECUTION AUTHORIZED / 51 REQUESTS MAX / ONE IN FLIGHT / NO AUTOMATIC RETRY`;
...
- ACS-CCV-R1-EVIDENCE-HARDENING: `REMOTE CANDIDATE AT
  ...
  ACCEPTED`;
- ACS-CCV-R1-R1-EVIDENCE-VALIDATOR-HARDENING: `OWNER ACCEPTED THROUGH SEED-TYPE
  CORRECTION 0c2552bf49923d45c2c5542cdb39f512a7e7d15d / TREE
  8ee5c3ba7ef214bfa3e56ca97cee0b73a3666bb4 / FULL CORE 464/464`;
- CCV-R1 main convergence: `PR #4 REBASE AND MERGE / MAIN
  9c13e8f8d7ccef079dd382fe11b1d173fdef13d7 / SAME ACCEPTED TREE / POST-MERGE
  REPOSITORY VALIDATION PASS`;
- ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G0: `OWNER ACCEPTED / COMPLETE /
  REMOTE-VERIFIED AT 9094a46615f2be9ca45f95418ac441326d326315 / TREE
  d372581f0f0f434e10df78542ef4ac9bbefbfb51 / PR #5 DRAFT / CI PASS`;
- ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G1: `REMOTE-VERIFIED CHECKPOINT AT
  af34ac074cb8bfbf334e4f56aad0c0d479b741be / TREE
  0cec29c8de8777c5c3dbb824b2a7f421d9cb9c36 / PR #6 DRAFT / CI PASS / FULL CORE
  464/464`;
- ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G2: `COLLECTION EXECUTED / ORIGINAL
  CUSTODY PVC NOT ATTACHED / INDEPENDENT REVIEW BLOCKED / CHECKPOINT CANDIDATE
  NOT DECLARED`;
- ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G2-R1: `INDEPENDENT REVIEW PASS /
  CLOSED AT 4132458d7f92e02dbd2e4be93476294aab825db6 / HISTORICAL MANIFEST REMAINS
  PARTIAL / NOT VALIDATION ACCEPTED`;
- CCV-R2-G0: `OWNER-AUTHORIZED AUTOMATED REVIEW PASS / CLOSED AT
  0376ee3c5b7a4c78735a04578a9a12fa1df6c2a2 / 45-RUN DESIGN FROZEN`;
- CCV-R2-G1: `OWNER-AUTHORIZED AUTOMATED PRE-GPU REVIEW PASS / CLOSED AT
  1989fd59b16c821e61ec122f89cee42e99ddacdb / 45 OF 45 REQUESTS VERIFIED / GPU EXECUTION NOT STARTED`;
- CCV-R2-G2: `FORMALLY CLOSED AT 6fa0388c86e3720e83fe2db183cc9a2615baf2f6 / PASS WITH REMEDIATION REQUIRED / VALIDATION NOT ACCEPTED / PRODUCTION READY NO`;
- CCV-R2-G3-G0: `COMPLETE / REMOTE-VERIFIED AT 41faaadf4c959944da3afd8c1d52b3e2429da68c / NO GPU`;
- CCV-R2-G3-G1: `HOST VALIDATION PASS / CLOSED / 51 OF 51 OPAQUE REQUESTS VERIFIED / READINESS e39ac4a8c3ddbf1f26571b295bcb00da7ff6b499acd49e8ad47291726bbbc5e4 / PREPARATION INVENTORY 20878b06608af6310cc1e60648d5b5e59a05cc6aa43475feb9ff3f9ae1e62845 / GPU AND COMFYUI QUEUE NOT STARTED`;
- CCV-R2-G3-G2: `PROJECT LEAD AUTHORIZED ON 2026-08-15 / BOUND TO G3-G1 READINESS / 51 REQUESTS MAX / ONE IN FLIGHT / NO AUTOMATIC RETRY / VALIDATION ACCEPTED FALSE / PRODUCTION READY NO`;
- Character Visual Identity Schema/ADR implementation: `NOT AUTHORIZED / NOT STARTED`;
