...
The current phase is `ACS-CCV-R1-EVIDENCE-HARDENING`.
...
- ACS-CCV-R1-EVIDENCE-HARDENING: `AUTHORIZED / EXPERIMENT EVIDENCE ONLY /
  INDEPENDENT REPRODUCTION NOT POSSIBLE / IN PROGRESS`;
