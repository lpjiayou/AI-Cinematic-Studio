...
The current phase is `ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G2-R1`.
...
- ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G2: `COLLECTION EXECUTED / ORIGINAL
  ...
  NOT DECLARED`;
- ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G2-R1: `OWNER AUTHORIZED / REPEAT
  SOURCE-READ-ONLY CUSTODY RECOVERY / PERSISTENCE AND REATTACH VERIFICATION
  REQUIRED / CCV-R2 NOT ACTIVE`;
