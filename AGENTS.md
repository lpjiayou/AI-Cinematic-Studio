...
The current phase is `ACS-CCV-R2-G0-REPRODUCIBLE-EXPERIMENT-DESIGN`.
...
- CCV-R2-G0: `OWNER AUTHORIZED / GOVERNANCE + REPRODUCIBLE EXPERIMENT DESIGN
  AUTHORING ACTIVE / NO GPU / NO PRODUCT OR SCHEMA IMPLEMENTATION`;
