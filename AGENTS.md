...
The current phase is `ACS-CCV-R2-G1-GPU-EXECUTION-PREPARATION`.
...
- CCV-R2-G1: `OWNER AUTHORIZED / GPU EXECUTION PREPARATION ACTIVE / READ-ONLY
  HOST PREFLIGHT + OFFLINE PROMPT MATERIALIZATION ONLY / NO GPU EXECUTION`;
