...
The current phase is `ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G0`.
...
- ACS-CCV-R1-HISTORICAL-EVIDENCE-CAPTURE-G0: `AUTHORIZED / CAPTURE PREPARATION
  ONLY / EXTERNAL GPU ACCESS NOT STARTED / THREE G1 TOOLING BLOCKERS OPEN`;
